...
export default function Home() {
  ...
  const toggleSensorMode = () => {
    const next: SensorMode =
      sensorMode === "SIMULATION_MODE" ? "REAL_SENSOR_MODE" : "SIMULATION_MODE";
    setSensorMode(next);
    setLogs(prev => [
      ...prev,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {examining && (
              <button onClick={toggleSensorMode} style={{
                ...
                color: sensorMode === "REAL_SENSOR_MODE" ? "#16a34a" : "#0284c7",
              }}>
                {sensorMode === "REAL_SENSOR_MODE" ? "🟢 Real Sensor" : "🔵 Simulation"}
              </button>
            )}
